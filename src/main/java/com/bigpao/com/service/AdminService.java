...
public class AdminService {
    ...
    public List<Admin> findAdminByadminIdAndadminPassword(String adminName,String Password){
        return adminDao.findAdminByadminNameAndadminPassword(adminName,Password);
    }
}
